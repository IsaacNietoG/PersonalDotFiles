...
\label{sec:org786c260}

Mi equipo de trabajo solamente tiene un usuario interactivo: el mío.

No hay mucho que definir aquí excepto tal vez el preludio a \ref{sec:org1393859} al definir que voy a usar zsh como emulador de terminal.
...
Comenzamos por agregar la ruta de los binarios de \ref{sec:orge04835c} la cual es por lo general:
...
El intended debería de ser que cada lenguaje de programación tenga su propia sección en \ref{sec:org0a1d3c4}, y con ello, su propio flujo de trabajo curado y asentado. Pero por ahora, dejaré varios lenguajes aquí sueltos sólo para no perder capacidades en mi IDE, mientras creo los flujos de trabajo correspondientes para cada idioma.
...
Finalmente, agregamos las líneas correspondientes a activar el \texttt{package} Org Edna. La función de este paquete la explico en la sección de \ref{sec:org9e20528}
...
\subsubsection{}
\label{sec:org093df81}
\section{Dropbox}
\label{sec:orgf87b5c2}

Utilizo Dropbox muy seguido para mantener la sincronización de mi agendaORG
\subsection{Instalación}
\label{sec:org6cdb782}

\begin{verbatim}
maestral
\end{verbatim}
\section{Virtual Box}
\label{sec:orgfab393b}
\begin{verbatim}
...
\end{verbatim}
\section{Zen Browser}
\label{sec:orge87e0b4}

\subsection{Instalación}
\label{sec:org677ffa0}
...
Luego agregro a mi \texttt{.zshrc} (véase \hyperref[sec:org1393859]{OhMyZSH}) algunas líneas que vienen también en su página. Las cuales son las siguientes:
