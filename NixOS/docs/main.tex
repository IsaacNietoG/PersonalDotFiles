...
\label{sec:orga65fda3}

Mi equipo de trabajo solamente tiene un usuario interactivo: el mío.

No hay mucho que definir aquí excepto tal vez el preludio a \ref{sec:orgd12ca85} al definir que voy a usar zsh como emulador de terminal.
...
Comenzamos por agregar la ruta de los binarios de \ref{sec:orged68a17} la cual es por lo general:
...
El intended debería de ser que cada lenguaje de programación tenga su propia sección en \ref{sec:org4a98573}, y con ello, su propio flujo de trabajo curado y asentado. Pero por ahora, dejaré varios lenguajes aquí sueltos sólo para no perder capacidades en mi IDE, mientras creo los flujos de trabajo correspondientes para cada idioma.
...
Finalmente, agregamos las líneas correspondientes a activar el \texttt{package} Org Edna. La función de este paquete la explico en la sección de \ref{sec:org5e92a67}
...
\subsubsection{}
\label{sec:orgc78a269}
\section{Dropbox}
\label{sec:orgb6a748b}

Utilizo Dropbox muy seguido para mantener la sincronización de mi agendaORG
\subsection{Instalación}
\label{sec:orgc9d3f0c}

\begin{verbatim}
maestral
\end{verbatim}
\section{Virtual Box}
\label{sec:org284a98c}
\begin{verbatim}
...
\end{verbatim}
\section{Zen Browser}
\label{sec:orgaf58b45}

\subsection{Instalación}
\label{sec:orgb57aeb7}
...
Luego agregro a mi \texttt{.zshrc} (véase \hyperref[sec:orgd12ca85]{OhMyZSH}) algunas líneas que vienen también en su página. Las cuales son las siguientes:
