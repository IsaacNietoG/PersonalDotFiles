...
\label{sec:org430ec99}

Mi equipo de trabajo solamente tiene un usuario interactivo: el mío.

No hay mucho que definir aquí excepto tal vez el preludio a \ref{sec:org15a51b6} al definir que voy a usar zsh como emulador de terminal.
...
Comenzamos por agregar la ruta de los binarios de \ref{sec:org0d6db56} la cual es por lo general:
...
\end{verbatim}
\subsection{GHCUP}
\label{sec:org177ec1c}

GHCUP es una herramienta que nos permite manejar varias versiones de Haskell y su GHC, en general, es el equivalente de \ref{sec:orgf500701} pero para Haskell.

\begin{verbatim}
[ -f "/home/mrtaichi/.ghcup/env" ] && . "/home/mrtaichi/.ghcup/env"
\end{verbatim}
\subsection{Terminal}
\label{sec:org8595e36}
...
\end{verbatim}
\subsection{NVM}
\label{sec:org927e3c6}

Finalmente tenemos a NVM, el cual es un manejador de versiones pero para Node, al igual que los anteriores \ref{sec:org177ec1c}
y \ref{sec:orgf500701}

\begin{verbatim}
source /usr/share/nvm/init-nvm.sh
\end{verbatim}
\section{Doom Emacs}
\label{sec:org0d6db56}
...
\subsubsection{}
\label{sec:org5ad91bd}
\section{Dropbox}
\label{sec:org84e5094}

Utilizo Dropbox muy seguido para mantener la sincronización de mi agendaORG
\subsection{Instalación}
\label{sec:orga0767c7}

\begin{verbatim}
maestral
\end{verbatim}
\section{Virtual Box}
\label{sec:org9aa0dcd}
\begin{verbatim}
...
\end{verbatim}
\section{Zen Browser}
\label{sec:orgdeddc9d}

\subsection{Instalación}
\label{sec:orge51d2a6}
