...
\label{sec:org8e6202b}

Mi equipo de trabajo solamente tiene un usuario interactivo: el mío.

No hay mucho que definir aquí excepto tal vez el preludio a \ref{sec:org777f3d7} al definir que voy a usar zsh como emulador de terminal.
...
Comenzamos por agregar la ruta de los binarios de \ref{sec:orgd31e244} la cual es por lo general:
...
El intended debería de ser que cada lenguaje de programación tenga su propia sección en \ref{sec:orgba2b14e}, y con ello, su propio flujo de trabajo curado y asentado. Pero por ahora, dejaré varios lenguajes aquí sueltos sólo para no perder capacidades en mi IDE, mientras creo los flujos de trabajo correspondientes para cada idioma.
...
Finalmente, agregamos las líneas correspondientes a activar el \texttt{package} Org Edna. La función de este paquete la explico en la sección de \ref{sec:org8ced1cb}
...
\subsubsection{}
\label{sec:org1080b8b}
\section{Dropbox}
\label{sec:org857b725}

Utilizo Dropbox muy seguido para mantener la sincronización de mi agendaORG
\subsection{Instalación}
\label{sec:orgac422db}

\begin{verbatim}
maestral
\end{verbatim}
\section{Virtual Box}
\label{sec:orgeac8b98}
\begin{verbatim}
...
\end{verbatim}
\section{Zen Browser}
\label{sec:org209a0cc}

\subsection{Instalación}
\label{sec:orge241acc}
...
Luego agregro a mi \texttt{.zshrc} (véase \hyperref[sec:org777f3d7]{OhMyZSH}) algunas líneas que vienen también en su página. Las cuales son las siguientes:
