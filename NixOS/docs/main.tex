...
\label{sec:org7c5d367}

Mi equipo de trabajo solamente tiene un usuario interactivo: el mío.

No hay mucho que definir aquí excepto tal vez el preludio a \ref{sec:org3ee8d9b} al definir que voy a usar zsh como emulador de terminal.
...
Comenzamos por agregar la ruta de los binarios de \ref{sec:org228c7b6} la cual es por lo general:
...
\end{verbatim}
\subsection{GHCUP}
\label{sec:org2344b56}

GHCUP es una herramienta que nos permite manejar varias versiones de Haskell y su GHC, en general, es el equivalente de \ref{sec:org5258394} pero para Haskell.

\begin{verbatim}
[ -f "/home/mrtaichi/.ghcup/env" ] && . "/home/mrtaichi/.ghcup/env"
\end{verbatim}
\subsection{Terminal}
\label{sec:org1488ca3}
...
\end{verbatim}
\subsection{NVM}
\label{sec:org4993992}

Finalmente tenemos a NVM, el cual es un manejador de versiones pero para Node, al igual que los anteriores \ref{sec:org2344b56}
y \ref{sec:org5258394}

\begin{verbatim}
source /usr/share/nvm/init-nvm.sh
\end{verbatim}
\section{Doom Emacs}
\label{sec:org228c7b6}
...
\subsubsection{}
\label{sec:orgfd81cdf}
\section{Dropbox}
\label{sec:org924aabb}

Utilizo Dropbox muy seguido para mantener la sincronización de mi agendaORG
\subsection{Instalación}
\label{sec:org02515f6}

\begin{verbatim}
maestral
\end{verbatim}
\section{Virtual Box}
\label{sec:orgd47780a}
\begin{verbatim}
...
\end{verbatim}
\section{Zen Browser}
\label{sec:org7e6b67a}

\subsection{Instalación}
\label{sec:org50eb234}
