...
\label{sec:org29db86e}

Mi equipo de trabajo solamente tiene un usuario interactivo: el mío.

No hay mucho que definir aquí excepto tal vez el preludio a \ref{sec:org0d0289d} al definir que voy a usar zsh como emulador de terminal.
...
Comenzamos por agregar la ruta de los binarios de \ref{sec:org740283b} la cual es por lo general:
...
El intended debería de ser que cada lenguaje de programación tenga su propia sección en \ref{sec:orgac81a50}, y con ello, su propio flujo de trabajo curado y asentado. Pero por ahora, dejaré varios lenguajes aquí sueltos sólo para no perder capacidades en mi IDE, mientras creo los flujos de trabajo correspondientes para cada idioma.
...
Finalmente, agregamos las líneas correspondientes a activar el \texttt{package} Org Edna. La función de este paquete la explico en la sección de \ref{sec:org393cc2f}
...
\subsubsection{}
\label{sec:orgeb7cf74}
\section{Dropbox}
\label{sec:orgf5c5b1b}

Utilizo Dropbox muy seguido para mantener la sincronización de mi agendaORG
\subsection{Instalación}
\label{sec:orgc313bdb}

\begin{verbatim}
maestral
\end{verbatim}
\section{Virtual Box}
\label{sec:org8de0a96}
\begin{verbatim}
...
\end{verbatim}
\section{Zen Browser}
\label{sec:org258a73b}

\subsection{Instalación}
\label{sec:org4e393c4}
...
Luego agregro a mi \texttt{.zshrc} (véase \hyperref[sec:org0d0289d]{OhMyZSH}) algunas líneas que vienen también en su página. Las cuales son las siguientes:
