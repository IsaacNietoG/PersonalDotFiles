...
\label{sec:org484c5c7}

Mi equipo de trabajo solamente tiene un usuario interactivo: el mío.

No hay mucho que definir aquí excepto tal vez el preludio a \ref{sec:orgb814cfb} al definir que voy a usar zsh como emulador de terminal.
...
Comenzamos por agregar la ruta de los binarios de \ref{sec:orgbb5ec86} la cual es por lo general:
...
El intended debería de ser que cada lenguaje de programación tenga su propia sección en \ref{sec:org6dfcec5}, y con ello, su propio flujo de trabajo curado y asentado. Pero por ahora, dejaré varios lenguajes aquí sueltos sólo para no perder capacidades en mi IDE, mientras creo los flujos de trabajo correspondientes para cada idioma.
...
Finalmente, agregamos las líneas correspondientes a activar el \texttt{package} Org Edna. La función de este paquete la explico en la sección de \ref{sec:orgbe37b05}
...
\subsubsection{}
\label{sec:orgf6b0433}
\section{Dropbox}
\label{sec:orgf581a93}

Utilizo Dropbox muy seguido para mantener la sincronización de mi agendaORG
\subsection{Instalación}
\label{sec:orga716b30}

\begin{verbatim}
maestral
\end{verbatim}
\section{Virtual Box}
\label{sec:org41dece6}
\begin{verbatim}
...
\end{verbatim}
\section{Zen Browser}
\label{sec:org02221ca}

\subsection{Instalación}
\label{sec:orge62233a}
...
Luego agregro a mi \texttt{.zshrc} (véase \hyperref[sec:orgb814cfb]{OhMyZSH}) algunas líneas que vienen también en su página. Las cuales son las siguientes:
