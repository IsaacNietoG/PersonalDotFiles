...
\label{sec:org3bff326}

Mi equipo de trabajo solamente tiene un usuario interactivo: el mío.

No hay mucho que definir aquí excepto tal vez el preludio a \ref{sec:org784c153} al definir que voy a usar zsh como emulador de terminal.
...
Comenzamos por agregar la ruta de los binarios de \ref{sec:org191baaa} la cual es por lo general:
...
El intended debería de ser que cada lenguaje de programación tenga su propia sección en \ref{sec:org093c648}, y con ello, su propio flujo de trabajo curado y asentado. Pero por ahora, dejaré varios lenguajes aquí sueltos sólo para no perder capacidades en mi IDE, mientras creo los flujos de trabajo correspondientes para cada idioma.
...
Finalmente, agregamos las líneas correspondientes a activar el \texttt{package} Org Edna. La función de este paquete la explico en la sección de \ref{sec:orge6aaa8f}
...
\subsubsection{}
\label{sec:org2ae8631}
\section{Dropbox}
\label{sec:org66c5507}

Utilizo Dropbox muy seguido para mantener la sincronización de mi agendaORG
\subsection{Instalación}
\label{sec:orgc731645}

\begin{verbatim}
maestral
\end{verbatim}
\section{Virtual Box}
\label{sec:org3d55a85}
\begin{verbatim}
...
\end{verbatim}
\section{Zen Browser}
\label{sec:org292aff3}

\subsection{Instalación}
\label{sec:org1cdb3c3}
...
Luego agregro a mi \texttt{.zshrc} (véase \hyperref[sec:org784c153]{OhMyZSH}) algunas líneas que vienen también en su página. Las cuales son las siguientes:
